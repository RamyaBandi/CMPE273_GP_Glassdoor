...
const { POST_STUDENT_REVIEW, GET_COMPANY_REVIEWS, GET_ALL_REVIEWS, GET_STUDENT_REVIEWS, POST_COMPANY_REPLY, PUT_COMPANY_REVIEW_HELPFUL } = require('../config/routeConstants');
