...
const { GET_ALL_JOBS, GET_COMPANY_JOBS_BY_JOBTITLE_OR_CITY, GET_COMPANY_JOBS_BY_CITY, GET_COMPANY_JOBS, POST_COMPANY_JOB, PUT_COMPANY_JOB, GET_COMPANY_JOB_BY_JOBID } = require('../config/routeConstants');
