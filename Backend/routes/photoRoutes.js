...
if (process.env.KAFKA_SWITCH === 'true') {
    photoRouter.route(POST_COMPANY_PHOTOS).post(checkAuth, photoKafkaServices.postCompanyPhotos);
    photoRouter.route(GET_COMPANY_PHOTOS).post(checkAuth, photoKafkaServices.getCompanyPhotos);
}
else {
